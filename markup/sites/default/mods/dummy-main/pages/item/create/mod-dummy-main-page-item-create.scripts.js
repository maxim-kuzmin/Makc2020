app['/mods/dummy-main/pages/item/create/'] = (function () {
    var _layout = (function () {
        var _body = (function () {
            ...
            function init(funcNext) {
                app.visibility.off([
                    'app--id--mod--dummy-main--page--item--edit--form--identifier--container',
                ...
                app.html.set({
                    'app--id--mod--dummy-main--page--item--edit--form': [{
                        attr: {
                            onclick: "return app['/mods/dummy-main/pages/item/create/'].view.form.submit()"
                        }
                    }]
                });
        ...
        var _menu1 = (function () {
            function init(funcNext) {
                app['/host/layout/menu1/'].init(app['/'].pages.mods.modDummyMain.item.create.path);
        ...
        var _menu2 = (function () {
            function init(funcNext) {
                app['/host/layout/menu2/'].init(app['/'].pages.mods.modDummyMain.item.create.path);
