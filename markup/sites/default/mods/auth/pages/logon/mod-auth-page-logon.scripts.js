app['/mods/auth/pages/logon/'] = (function () {
    var _layout = (function () {
        var _body = (function () {
            var _notifications = (function () {
                ...
                function load(funcNext) {
                    app['/host/controls/notifications/'].start(
                        '--form',
                        'app--id--mod--auth--page--logon--form',
                        setup,
                        app.html.setToEnd,
                        funcNext
                    );
            ...
            function init(funcNext) {
                app.visibility.off([
                    'app--id--mod--auth--page--logon--form--name--error',
                    'app--id--mod--auth--page--logon--form--password--error'
                ]);
            ...
            function load (funcNext) {
                app.html.load({
                    'app--id--host--layout--body': [
                        'mods/auth/pages/logon/mod-auth-page-logon.template.html',
                        init,
                        _summaryErrors.load,
                        _notifications.load,
                        funcNext
        ...
        var _menu1 = (function () {
            function init(funcNext) {
                app['/host/layout/menu1/'].init(app['/'].pages.mods.modAuth.logon.path);
        ...
        var _menu2 = (function () {
            function init(funcNext) {
                app['/host/layout/menu2/'].init(app['/'].pages.mods.modAuth.logon.path);
    ...
    var _view = (function () {
        var _form = (function () {
            function submit() {
                var isOk = app.html.hasAllValue([
                    'app--id--mod--auth--page--logon--form--name',
                    'app--id--mod--auth--page--logon--form--password'
                ]);
