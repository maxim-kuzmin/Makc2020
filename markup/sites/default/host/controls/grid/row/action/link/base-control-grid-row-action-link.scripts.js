app['/host/controls/grid/row/action/link/'] = (function () {
    var _ID_ELEMENT = 'app--id--host--control--grid--row--action--link';
    ...
    function start(index, containerId, funcSetup, funcRender, funcNext) {
        ...
        app.data.load(
            'host/controls/grid/row/action/link/base-control-grid-row-action-link.template.html',
