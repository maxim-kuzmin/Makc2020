...
namespace Makc2020.Mods.DummyTree.Caching.Jobs.Filtered.Get
{
    /// <summary>
    /// Мод "DummyTree". Кэширование. Задания. Список. Получение. Сервис.
    /// </summary>
    public class ModDummyTreeCachingJobFilteredGetService : ModDummyTreeBaseJobFilteredGetService
    {
        #region Constructors
        ...
        public ModDummyTreeCachingJobFilteredGetService(
            ...
            ) : base(executable, coreBaseResourceErrors)
        {
            ...
            {
                var client = new CoreCachingClientWithChangeAndRead<ModDummyTreeBaseJobFilteredGetOutput>(
                    "Filtered.Get",
                    cacheSettings,
                    cache,
