...
namespace Makc2020.Core.Base.Common.Mod.Data.Db.Loaders
{
    /// <summary>
    /// Ядро. Основа. Общее. Мод. Данные. База данных. Загрузчик списка.
    /// </summary>
    /// <typeparam name="TDataList">Тип данных списка.</typeparam>
    /// <typeparam name="TDataItem">Тип данных элемента.</typeparam>
    public abstract class CoreBaseCommonModDataDbLoaderList<TDataList, TDataItem> :
        CoreBaseDataLoader<TDataList>
        where TDataList : CoreBaseCommonModJobListGetOutput<TDataItem>, new()
        where TDataItem : class, new()
    {
        ...
        public CoreBaseCommonModDataDbLoaderList(
