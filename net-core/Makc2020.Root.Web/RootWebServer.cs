...
namespace Makc2020.Root.Web
{
        ...
        where TConfigurator : RootBaseConfigurator<TContext, TModules>
    {
        ...
        /// <summary>
        /// Обработать событие начала отклика.
        /// </summary>
        /// <param name="httpContext">HTTP-контекст.</param>
        protected virtual Task OnResponseStarting(HttpContext httpContext)
        {
            Logger.LogDebug("RootWebServer.OnResponseStarting begin");
            ...
            Logger.LogDebug("RootWebServer.OnResponseStarting end");
