...
namespace Makc2020.Core.Data.Base
{
    /// <summary>
    /// Ядро. Данные. Основа. Настройка.
    /// </summary>
    /// <typeparam name="TDefaults">Тип значений по умолчанию.</typeparam>
    public abstract class CoreDataBaseSetting<TDefaults>
        where TDefaults: CoreDataBaseDefaults
    {
        #region Properties
        ...
        public CoreDataBaseSetting(TDefaults defaults, string dbTable, string dbSchema = null)
        {
            Defaults = defaults;
            DbTable = dbTable;
