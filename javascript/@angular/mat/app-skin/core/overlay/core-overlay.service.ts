...
import {AppSkinCoreOverlayContainer} from './core-overlay-container';

/** Ядро. Наложение. Сервис. */
@Injectable({
  providedIn: 'root'
})
export class AppSkinCoreOverlayService extends Overlay {

  private readonly __scrollStrategies: ScrollStrategyOptions;
  private readonly __overlayContainer: AppSkinCoreOverlayContainer;
  ...
  constructor(
    ...
    _overlayContainer: AppSkinCoreOverlayContainer,
