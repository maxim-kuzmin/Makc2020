...
import {AppSkinCoreOverlayService} from '../overlay/core-overlay.service';
...
export class AppSkinCoreSpinnerService extends AppCoreSpinnerService {
  ...
  /**
   * Конструктор.
   * @param {AppSkinCoreOverlayService} appCoreOverlay Наложение.
   */
  constructor(
    private appCoreOverlay: AppSkinCoreOverlayService
  ) {
    super();
  }
