...
import {AppSkinHostLayoutCommonMessageRef} from '../../host/layout/common/message/host-layout-common-message-ref';

/** Ядро. Извещение. Сервис. */
@Injectable({
  providedIn: 'root'
})
export class AppSkinHostLayoutCommonMessageService extends AppCoreNotificationService {
  ...
  private createNotificationRef(
    ...
    messages: string[]
  ): AppSkinHostLayoutCommonMessageRef {
    let summary: string;
    ...
    return new AppSkinHostLayoutCommonMessageRef(this.extMessage);
  }
}
